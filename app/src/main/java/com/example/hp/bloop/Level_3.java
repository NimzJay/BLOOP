...
public class Level_3 extends View
{
    ...
    public Level_3(Context context)
    {
        ...
        backgroundImage = BitmapFactory.decodeResource(getResources(), R.drawable.qwe4);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if(score > 300)
        {
            ...
            Intent nextLevel2 = new Intent(getContext(), level3Up.class);
